  ...
  return (
    <AdminLayout>
      <div className="w-full mt-4">
        ...
        <p className="w-1/3 border-1 font-medium border-gray-400 my-2 lg:text-base text-xs">
          LogBook Images
        </p>
        ...
        <div className="w-full border-1 border-gray-400 mt-4 p-2">
          ...
          <div className="lg:flex lg:flex-row lg:justify-center lg:gap-20 w-full">
            <div className="border-1 border-sky-300 lg:h-96 lg:w-52 w-full h-96 lg:my-0 my-4">
              <p className="border-b-2 border-black  ">Photo</p>
            </div>
            <div className="border-1 border-sky-300 lg:h-96 lg:w-52 w-full h-96 lg:my-0 my-4">
              <p className="border-b-2 border-black  ">Photo</p>
...
export default Phase_Controller;
